...
def plot_play_frame(ax, frame, player_data, ball_data, los, togo_line, play_desc, team_colors):
    ...
    ax.text(0.5, 1.05, f"{play_desc} (Frame: {frame})", horizontalalignment='center', verticalalignment='center',
